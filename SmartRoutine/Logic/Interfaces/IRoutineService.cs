...
namespace SmartRoutine.Logic.Interfaces
{
    public interface IRoutineService
    {
        ...
        void AddStep(string routineId, StepType type, string value, string description);
        void UpdateStep(string routineId, string stepId, string value, string description);
